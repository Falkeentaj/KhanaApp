package com.example.khanaapp.AdministratorUser;
...
import com.example.khanaapp.AdministratorUser.Model.UserAdministrator;
import com.example.khanaapp.R;
...
public class AdministratorSignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminstrator_sign_in);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.child(localPhone).exists()) {
                    ...
                    if (user.getPassword().equals(localPassword)) {
                        Intent login = new Intent(AdministratorSignInActivity.this, AddRestaurants.class);
